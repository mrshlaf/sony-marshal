    ...
    <section ref={containerRef} className="relative w-full h-[80vh] md:h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-6">
         <div className="lifestyle-text">
            ...
            <h2 className="text-5xl md:text-8xl font-semibold tracking-tighter text-white mb-10 leading-none">
              Capture every <br /> <span className="italic font-serif">Kando</span> moment.
            </h2>
