...
export function Vision() {
  ...
  return (
    <section ref={containerRef} className="relative py-12 md:py-24 bg-[#0d0d0d] text-white overflow-hidden border-t border-white/5">
      <div className="absolute inset-0 z-0">
        <Image src="/images/sony1.jpg" alt="Sony Vision" fill className="object-cover opacity-10 grayscale" />
      </div>

      <div className="relative z-10 max-w-[1400px] mx-auto px-10 md:px-12 flex flex-col lg:flex-row gap-8 lg:items-end">
        <div className="w-full lg:w-7/12 text-left">
          <h2 className="text-4xl md:text-8xl font-bold tracking-tighter leading-none md:leading-[0.85] mb-6 uppercase text-white">
            Innovating <br /> <span className="text-zinc-700">the Future.</span>
          </h2>
          <p className="text-sm md:text-lg text-zinc-400 font-bold uppercase tracking-widest max-w-xl">
             Our commitment to a legacy where creativity and technology co-exist in harmony.
          </p>
        </div>

        <div className="w-full lg:w-5/12 flex flex-col gap-6 md:gap-8 border-l border-white/10 pl-8 md:pl-12 mt-8 lg:mt-0">
          {[
